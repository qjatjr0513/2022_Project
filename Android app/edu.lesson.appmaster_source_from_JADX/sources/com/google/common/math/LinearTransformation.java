...
public abstract class LinearTransformation {
    ...
    public static final class LinearTransformationBuilder {
        ...
        /* renamed from: x1 */
        private final double f133x1;

        /* renamed from: y1 */
        private final double f134y1;
        ...
        public LinearTransformation and(double x2, double y2) {
            ...
            double d = this.f133x1;
            if (x2 != d) {
                return withSlope((y2 - this.f134y1) / (x2 - d));
            }
            if (y2 == this.f134y1) {
                z = false;
            }
            Preconditions.checkArgument(z);
            return new VerticalLinearTransformation(this.f133x1);
        }
        ...
        public LinearTransformation withSlope(double slope) {
            ...
            if (DoubleUtils.isFinite(slope)) {
                return new RegularLinearTransformation(slope, this.f134y1 - (this.f133x1 * slope));
            }
            return new VerticalLinearTransformation(this.f133x1);
        }
    }
    ...
    private static final class VerticalLinearTransformation extends LinearTransformation {
        ...
        public String toString() {
            return String.format("x = %g", new Object[]{Double.valueOf(this.f135x)});
        }

        private LinearTransformation createInverse() {
            return new RegularLinearTransformation(0.0d, this.f135x, this);
        }
    }
