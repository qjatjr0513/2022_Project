...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m60of() {
        return RegularImmutableMap.EMPTY;
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m61of(K k1, V v1) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        return RegularImmutableMap.create(1, new Object[]{k1, v1});
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m62of(K k1, V v1, K k2, V v2) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m63of(K k1, V v1, K k2, V v2, K k3, V v3) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        CollectPreconditions.checkEntryNotNull(k2, v2);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m64of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m65of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    public ImmutableSetMultimap<K, V> asMultimap() {
        if (isEmpty()) {
            return ImmutableSetMultimap.m90of();
        }
    ...
    private final class MapViewOfValuesAsSingletonSets extends IteratorBasedImmutableMap<K, ImmutableSet<V>> {
        ...
        public ImmutableSet<V> get(@NullableDecl Object key) {
            ...
            return ImmutableSet.m84of(outerValue);
        }
                ...
                public Map.Entry<K, ImmutableSet<V>> next() {
                    ...
                    return new AbstractMapEntry<K, ImmutableSet<V>>(this) {
                        ...
                        public ImmutableSet<V> getValue() {
                            return ImmutableSet.m84of(backingEntry.getValue());
                        }
                    };
                }
            };
