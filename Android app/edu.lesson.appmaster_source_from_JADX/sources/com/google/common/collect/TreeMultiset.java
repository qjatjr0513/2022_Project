...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    private long aggregateBelowRange(Aggregate aggr, @NullableDecl AvlNode<E> node) {
        ...
        switch (C03344.$SwitchMap$com$google$common$collect$BoundType[this.range.getLowerBoundType().ordinal()]) {
            case 1:
    ...
    private long aggregateAboveRange(Aggregate aggr, @NullableDecl AvlNode<E> node) {
        ...
        switch (C03344.$SwitchMap$com$google$common$collect$BoundType[this.range.getUpperBoundType().ordinal()]) {
            case 1:
