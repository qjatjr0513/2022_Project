...
public final class Predicates {
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m18or(Iterable<? extends Predicate<? super T>> components) {
        return new OrPredicate(defensiveCopy(components));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m19or(Predicate<? super T>... components) {
        return new OrPredicate(defensiveCopy((T[]) components));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m17or(Predicate<? super T> first, Predicate<? super T> second) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m16in(Collection<? extends T> target) {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f69f;

        /* renamed from: p */
        final Predicate<B> f70p;

        private CompositionPredicate(Predicate<B> p, Function<A, ? extends B> f) {
            this.f70p = (Predicate) Preconditions.checkNotNull(p);
            this.f69f = (Function) Preconditions.checkNotNull(f);
        }

        public boolean apply(@NullableDecl A a) {
            return this.f70p.apply(this.f69f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f69f.equals(that.f69f) || !this.f70p.equals(that.f70p)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f69f.hashCode() ^ this.f70p.hashCode();
        }

        public String toString() {
            String valueOf = String.valueOf(this.f70p);
            String valueOf2 = String.valueOf(this.f69f);
