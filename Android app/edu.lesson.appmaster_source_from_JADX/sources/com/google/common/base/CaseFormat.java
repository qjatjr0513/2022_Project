...
public enum CaseFormat {
    ...
    LOWER_UNDERSCORE(CharMatcher.m4is('_'), "_") {
        /* access modifiers changed from: package-private */
        public String normalizeWord(String word) {
            return Ascii.toLowerCase(word);
        }
    ...
    UPPER_UNDERSCORE(CharMatcher.m4is('_'), "_") {
        /* access modifiers changed from: package-private */
        public String normalizeWord(String word) {
    ...
    /* renamed from: to */
    public final String mo1893to(CaseFormat format, String str) {
    ...
    private static final class StringConverter extends Converter<String, String> implements Serializable {
        ...
        public String doForward(String s) {
            return this.sourceFormat.mo1893to(this.targetFormat, s);
        }

        /* access modifiers changed from: protected */
        public String doBackward(String s) {
            return this.targetFormat.mo1893to(this.sourceFormat, s);
        }
