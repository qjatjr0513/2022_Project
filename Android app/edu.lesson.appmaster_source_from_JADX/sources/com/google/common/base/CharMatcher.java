...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m4is(char match) {
        return new C0067Is(match);
    }
    ...
    /* renamed from: or */
    public CharMatcher mo1914or(CharMatcher other) {
        return new C0068Or(this, other);
    }
    ...
    private static CharMatcher precomputedPositive(int totalCharacters, BitSet table, String description) {
        switch (totalCharacters) {
            case 0:
                return none();
            case 1:
                return m4is((char) table.nextSetBit(0));
            case 2:
    ...
    private static final class C0068Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C0068Or(CharMatcher a, CharMatcher b) {
            this.first = (CharMatcher) Preconditions.checkNotNull(a);
            this.second = (CharMatcher) Preconditions.checkNotNull(b);
        }
    ...
    private static final class C0067Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo1914or(CharMatcher other) {
            return other.matches(this.match) ? other : super.mo1914or(other);
        }
