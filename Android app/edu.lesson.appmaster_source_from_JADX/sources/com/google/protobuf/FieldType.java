...
public enum FieldType {
    ...
    private FieldType(int id, Collection collection2, JavaType javaType2) {
        ...
        switch (C10151.$SwitchMap$com$google$protobuf$FieldType$Collection[collection2.ordinal()]) {
            case 1:
        ...
        if (collection2 == Collection.SCALAR) {
            switch (C10151.$SwitchMap$com$google$protobuf$JavaType[javaType2.ordinal()]) {
                case 1:
                case 2:
                case 3:
                    break;
