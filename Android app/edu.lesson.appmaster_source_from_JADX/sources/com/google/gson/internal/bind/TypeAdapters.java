...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory ENUM_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> com.google.gson.TypeAdapter<T> create(com.google.gson.Gson r3, com.google.gson.reflect.TypeToken<T> r4) {
            ...
            L_0x0021:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C094828.create(com.google.gson.Gson, com.google.gson.reflect.TypeToken):com.google.gson.TypeAdapter");
        }
    };
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() {
            public BitSet read(JsonReader in) throws IOException {
                ...
                while (tokenType != JsonToken.END_ARRAY) {
                    boolean set = false;
                    switch (C095634.$SwitchMap$com$google$gson$stream$JsonToken[tokenType.ordinal()]) {
                        case 1:
                            if (in.nextInt() != 0) {
                                set = true;
                                break;
        ...
        C09503 r0 = new TypeAdapter<Boolean>() {
            public Boolean read(JsonReader in) throws IOException {
        ...
        C09585 r02 = new TypeAdapter<Number>() {
            public Number read(JsonReader in) throws IOException {
                if (in.peek() == JsonToken.NULL) {
                    in.nextNull();
                    return null;
        ...
        C09596 r03 = new TypeAdapter<Number>() {
            public Number read(JsonReader in) throws IOException {
                if (in.peek() == JsonToken.NULL) {
                    in.nextNull();
                    return null;
        ...
        C09607 r04 = new TypeAdapter<Number>() {
            public Number read(JsonReader in) throws IOException {
                if (in.peek() == JsonToken.NULL) {
                    in.nextNull();
                    return null;
        ...
        C093314 r05 = new TypeAdapter<Character>() {
        ...
        C093415 r06 = new TypeAdapter<String>() {
        ...
        C093718 r07 = new TypeAdapter<StringBuilder>() {
        ...
        C093819 r08 = new TypeAdapter<StringBuffer>() {
        ...
        C094020 r09 = new TypeAdapter<URL>() {
        ...
        C094121 r010 = new TypeAdapter<URI>() {
        ...
        C094222 r011 = new TypeAdapter<InetAddress>() {
        ...
        C094323 r012 = new TypeAdapter<UUID>() {
        ...
        C094525 r013 = new TypeAdapter<Calendar>() {
        ...
        C094626 r014 = new TypeAdapter<Locale>() {
        ...
        C094727 r015 = new TypeAdapter<JsonElement>() {
            public JsonElement read(JsonReader in) throws IOException {
                if (in instanceof JsonTreeReader) {
                    return ((JsonTreeReader) in).nextJsonElement();
                }
                switch (C095634.$SwitchMap$com$google$gson$stream$JsonToken[in.peek().ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C095634 {
