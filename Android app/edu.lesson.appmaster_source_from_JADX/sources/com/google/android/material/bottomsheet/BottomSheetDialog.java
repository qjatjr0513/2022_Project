...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public BottomSheetDialog(Context context) {
        this(context, 0);
        this.edgeToEdgeEnabled = getContext().getTheme().obtainStyledAttributes(new int[]{C2436R.attr.enableEdgeToEdge}).getBoolean(0, false);
    }
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), C2436R.layout.design_bottom_sheet_dialog, (ViewGroup) null);
            this.container = frameLayout;
            this.coordinator = (CoordinatorLayout) frameLayout.findViewById(C2436R.C2439id.coordinator);
            FrameLayout frameLayout2 = (FrameLayout) this.container.findViewById(C2436R.C2439id.design_bottom_sheet);
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        ensureContainerAndBehavior();
        CoordinatorLayout coordinator2 = (CoordinatorLayout) this.container.findViewById(C2436R.C2439id.coordinator);
        ...
        coordinator2.findViewById(C2436R.C2439id.touch_outside).setOnClickListener(new View.OnClickListener() {
    ...
    private static int getThemeResId(Context context, int themeId) {
        ...
        if (context.getTheme().resolveAttribute(C2436R.attr.bottomSheetDialogTheme, outValue, true)) {
            return outValue.resourceId;
        }
        return C2436R.style.Theme_Design_Light_BottomSheetDialog;
    }
