...
class FloatingActionButtonImpl {
    ...
    private AnimatorSet createDefaultAnimator(float targetOpacity, float targetScale, float targetIconScale) {
        ...
        C20874 r0 = new ValueAnimator.AnimatorUpdateListener() {
        ...
        AnimatorSetCompat.playTogether(set, animators);
        set.setDuration((long) MotionUtils.resolveThemeDuration(this.view.getContext(), C2436R.attr.motionDurationLong1, this.view.getContext().getResources().getInteger(C2436R.integer.material_motion_duration_long_1)));
        set.setInterpolator(MotionUtils.resolveThemeInterpolator(this.view.getContext(), C2436R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        return set;
    }
