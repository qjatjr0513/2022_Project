...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C2436R.style.Widget_MaterialComponents_BottomAppBar;
    ...
    public BottomAppBar(Context context, AttributeSet attrs) {
        this(context, attrs, C2436R.attr.bottomAppBarStyle);
    }
    ...
    public BottomAppBar(android.content.Context r12, android.util.AttributeSet r13, int r14) {
        /*
            ...
            int[] r2 = com.google.android.material.C2436R.styleable.BottomAppBar
            int[] r5 = new int[r8]
            r0 = r12
            r1 = r13
            r3 = r14
            ...
            int r1 = com.google.android.material.C2436R.styleable.BottomAppBar_backgroundTint
            ...
            int r2 = com.google.android.material.C2436R.styleable.BottomAppBar_navigationIconTint
        ...
        L_0x0050:
            int r2 = com.google.android.material.C2436R.styleable.BottomAppBar_elevation
            int r2 = r0.getDimensionPixelSize(r2, r8)
            int r3 = com.google.android.material.C2436R.styleable.BottomAppBar_fabCradleMargin
            int r3 = r0.getDimensionPixelOffset(r3, r8)
            float r3 = (float) r3
            int r4 = com.google.android.material.C2436R.styleable.BottomAppBar_fabCradleRoundedCornerRadius
            int r4 = r0.getDimensionPixelOffset(r4, r8)
            float r4 = (float) r4
            int r5 = com.google.android.material.C2436R.styleable.BottomAppBar_fabCradleVerticalOffset
            int r5 = r0.getDimensionPixelOffset(r5, r8)
            float r5 = (float) r5
            int r9 = com.google.android.material.C2436R.styleable.BottomAppBar_fabAlignmentMode
            int r9 = r0.getInt(r9, r8)
            r11.fabAlignmentMode = r9
            int r9 = com.google.android.material.C2436R.styleable.BottomAppBar_fabAnimationMode
            int r9 = r0.getInt(r9, r8)
            r11.fabAnimationMode = r9
            int r9 = com.google.android.material.C2436R.styleable.BottomAppBar_hideOnScroll
            boolean r9 = r0.getBoolean(r9, r8)
            r11.hideOnScroll = r9
            int r9 = com.google.android.material.C2436R.styleable.BottomAppBar_paddingBottomSystemWindowInsets
            boolean r9 = r0.getBoolean(r9, r8)
            r11.paddingBottomSystemWindowInsets = r9
            int r9 = com.google.android.material.C2436R.styleable.BottomAppBar_paddingLeftSystemWindowInsets
            boolean r9 = r0.getBoolean(r9, r8)
            r11.paddingLeftSystemWindowInsets = r9
            int r9 = com.google.android.material.C2436R.styleable.BottomAppBar_paddingRightSystemWindowInsets
            boolean r8 = r0.getBoolean(r9, r8)
            r11.paddingRightSystemWindowInsets = r8
            r0.recycle()
            android.content.res.Resources r8 = r11.getResources()
            int r9 = com.google.android.material.C2436R.dimen.mtrl_bottomappbar_fabOffsetEndMode
        ...
        private final View.OnLayoutChangeListener fabLayoutListener = new View.OnLayoutChangeListener() {
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                ...
                if (Behavior.this.originalBottomMargin == 0) {
                    fabLayoutParams.bottomMargin = child.getBottomInset() + (child.getResources().getDimensionPixelOffset(C2436R.dimen.mtrl_bottomappbar_fab_bottom_margin) - ((fab.getMeasuredHeight() - height) / 2));
            ...
            if (dependentView != null && !ViewCompat.isLaidOut(dependentView)) {
                ...
                if (dependentView instanceof FloatingActionButton) {
                    ...
                    if (fab.getShowMotionSpec() == null) {
                        fab.setShowMotionSpecResource(C2436R.animator.mtrl_fab_show_motion_spec);
                    }
                    if (fab.getHideMotionSpec() == null) {
                        fab.setHideMotionSpecResource(C2436R.animator.mtrl_fab_hide_motion_spec);
                    }
