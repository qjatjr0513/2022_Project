...
public abstract class NavigationBarMenuView extends ViewGroup implements MenuView {
    ...
    public NavigationBarMenuView(Context context) {
        ...
        autoTransition.setDuration((long) MotionUtils.resolveThemeDuration(getContext(), C2436R.attr.motionDurationLong1, getResources().getInteger(C2436R.integer.material_motion_duration_long_1)));
        autoTransition.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C2436R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
