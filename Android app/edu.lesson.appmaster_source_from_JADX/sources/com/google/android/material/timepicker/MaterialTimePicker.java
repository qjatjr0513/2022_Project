...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int surfaceColor = MaterialAttributes.resolveOrThrow(context, C2436R.attr.colorSurface, MaterialTimePicker.class.getCanonicalName());
        MaterialShapeDrawable background = new MaterialShapeDrawable(context, (AttributeSet) null, C2436R.attr.materialTimePickerStyle, C2436R.style.Widget_MaterialComponents_TimePicker);
        TypedArray a = context.obtainStyledAttributes((AttributeSet) null, C2436R.styleable.MaterialTimePicker, C2436R.attr.materialTimePickerStyle, C2436R.style.Widget_MaterialComponents_TimePicker);
        this.clockIcon = a.getResourceId(C2436R.styleable.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = a.getResourceId(C2436R.styleable.MaterialTimePicker_keyboardIcon, 0);
        a.recycle();
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ViewGroup root = (ViewGroup) layoutInflater.inflate(C2436R.layout.material_timepicker_dialog, viewGroup);
        TimePickerView timePickerView2 = (TimePickerView) root.findViewById(C2436R.C2439id.material_timepicker_view);
        this.timePickerView = timePickerView2;
        timePickerView2.setOnDoubleTapListener(this);
        this.textInputStub = (ViewStub) root.findViewById(C2436R.C2439id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) root.findViewById(C2436R.C2439id.material_timepicker_mode_button);
        TextView headerTitle = (TextView) root.findViewById(C2436R.C2439id.header_title);
        ...
        Button okButton = (Button) root.findViewById(C2436R.C2439id.material_timepicker_ok_button);
        ...
        Button button = (Button) root.findViewById(C2436R.C2439id.material_timepicker_cancel_button);
    ...
    private Pair<Integer, Integer> dataForMode(int mode) {
        switch (mode) {
            case 0:
                return new Pair<>(Integer.valueOf(this.keyboardIcon), Integer.valueOf(C2436R.string.material_timepicker_text_input_mode_description));
            case 1:
                return new Pair<>(Integer.valueOf(this.clockIcon), Integer.valueOf(C2436R.string.material_timepicker_clock_mode_description));
            default:
    ...
    private int getThemeResId() {
        ...
        TypedValue value = MaterialAttributes.resolve(requireContext(), C2436R.attr.materialTimePickerTheme);
        if (value == null) {
            return 0;
        }
        return value.data;
