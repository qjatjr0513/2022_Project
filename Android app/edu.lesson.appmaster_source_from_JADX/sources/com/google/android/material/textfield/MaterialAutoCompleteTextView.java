...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2436R.attr.autoCompleteTextViewStyle);
    }
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C2436R.styleable.MaterialAutoCompleteTextView, defStyleAttr, C2436R.style.Widget_AppCompat_AutoCompleteTextView, new int[0]);
        if (attributes.hasValue(C2436R.styleable.MaterialAutoCompleteTextView_android_inputType) && attributes.getInt(C2436R.styleable.MaterialAutoCompleteTextView_android_inputType, 0) == 0) {
