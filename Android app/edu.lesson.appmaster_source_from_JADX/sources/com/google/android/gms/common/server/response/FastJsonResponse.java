...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        public static Field<byte[], byte[]> forBase64(String outputFieldName, int safeParcelableId) {
            return new Field(8, false, 8, false, outputFieldName, safeParcelableId, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
        }

        public static Field<Boolean, Boolean> forBoolean(String outputFieldName, int safeParcelableId) {
            return new Field(6, false, 6, false, outputFieldName, safeParcelableId, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
        }
        ...
        public static Field<Double, Double> forDouble(String outputFieldName, int safeParcelableId) {
            return new Field(4, false, 4, false, outputFieldName, safeParcelableId, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
        }

        public static Field<Float, Float> forFloat(String outputFieldName, int safeParcelableId) {
            return new Field(3, false, 3, false, outputFieldName, safeParcelableId, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
        }

        public static Field<Integer, Integer> forInteger(String outputFieldName, int safeParcelableId) {
            return new Field(0, false, 0, false, outputFieldName, safeParcelableId, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
        }

        public static Field<Long, Long> forLong(String outputFieldName, int safeParcelableId) {
            return new Field(2, false, 2, false, outputFieldName, safeParcelableId, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
        }

        public static Field<String, String> forString(String outputFieldName, int safeParcelableId) {
            return new Field(7, false, 7, false, outputFieldName, safeParcelableId, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
        }

        public static Field<HashMap<String, String>, HashMap<String, String>> forStringMap(String outputFieldName, int safeParcelableId) {
            return new Field(10, false, 10, false, outputFieldName, safeParcelableId, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
        }

        public static Field<ArrayList<String>, ArrayList<String>> forStrings(String outputFieldName, int safeParcelableId) {
            return new Field(7, true, 7, true, outputFieldName, safeParcelableId, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
        }
        ...
        public static Field withConverter(String outputFieldName, int safeParcelableId, FieldConverter<?, ?> converter, boolean inputArrayType) {
            converter.zaa();
            converter.zab();
            return new Field(7, inputArrayType, 0, false, outputFieldName, safeParcelableId, (Class<? extends FastJsonResponse>) null, converter);
        }
