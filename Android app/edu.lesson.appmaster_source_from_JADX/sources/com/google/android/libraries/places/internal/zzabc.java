...
final class zzabc extends zzabf {
    ...
    public final void zze(int i, zzaax zzaax) throws IOException {
        zzq((i << 3) | 2);
        zzq(zzaax.zzd());
        zzaax.zzh(this);
    }
    ...
    public final void zzg(int i) throws IOException {
        try {
            ...
            throw new zzabd(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1}), e);
        }
    }
    ...
    public final void zzn(String str) throws IOException {
        ...
        try {
            ...
            if (zzA2 == zzA) {
                int i2 = i + zzA2;
                this.zzd = i2;
                int zzb2 = zzaep.zzb(str, this.zzb, i2, this.zzc - i2);
                this.zzd = i;
                zzq((zzb2 - i) - zzA2);
                this.zzd = zzb2;
                return;
            ...
            byte[] bArr = this.zzb;
            int i3 = this.zzd;
            this.zzd = zzaep.zzb(str, bArr, i3, this.zzc - i3);
        } catch (zzaeo e) {
            this.zzd = i;
            zzE(str, e);
    ...
    public final void zzc(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzabd(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), Integer.valueOf(i2)}), e);
        }
    }
    ...
    public final void zzs(long j) throws IOException {
        if (!zzabf.zzc || this.zzc - this.zzd < 10) {
            ...
            while ((j & -128) != 0) {
                ...
                int i3 = this.zzd;
                this.zzd = i3 + 1;
                zzael.zzn(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr4 = this.zzb;
            int i4 = this.zzd;
            this.zzd = i4 + 1;
            zzael.zzn(bArr4, (long) i4, (byte) ((int) j));
        }
    }
}
