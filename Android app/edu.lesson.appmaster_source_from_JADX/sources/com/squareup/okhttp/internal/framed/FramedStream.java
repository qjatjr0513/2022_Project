...
public final class FramedStream {
    ...
    public boolean isLocallyInitiated() {
        if (this.connection.client == ((this.f309id & 1) == 1)) {
            return true;
        }
        return false;
    }
    ...
    public void reply(List<Header> responseHeaders2, boolean out) throws IOException {
        if (!Thread.holdsLock(this)) {
            ...
            this.connection.writeSynReply(this.f309id, outFinished, responseHeaders2);
            if (outFinished) {
    ...
    public void close(ErrorCode rstStatusCode) throws IOException {
        if (closeInternal(rstStatusCode)) {
            this.connection.writeSynReset(this.f309id, rstStatusCode);
        }
    }

    public void closeLater(ErrorCode errorCode2) {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynResetLater(this.f309id, errorCode2);
        }
    }
    ...
    private boolean closeInternal(ErrorCode errorCode2) {
        if (!Thread.holdsLock(this)) {
            synchronized (this) {
                ...
                notifyAll();
                this.connection.removeStream(this.f309id);
                return true;
            }
        }
        throw new AssertionError();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:10:0x0018, code lost:
        r3.connection.removeStream(r3.f309id);
     */
    ...
    private final class FramedDataSource implements Source {
        ...
        public long read(okio.Buffer r16, long r17) throws java.io.IOException {
            ...
            L_0x0020:
                ...
                int r10 = r10.f309id     // Catch:{ all -> 0x00b4 }
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x003b, code lost:
        r4.connection.removeStream(r4.f309id);
     */
    ...
    final class FramedDataSink implements Sink {
        ...
        private void emitDataFrame(boolean r10) throws java.io.IOException {
            ...
            L_0x002c:
                ...
                com.squareup.okhttp.internal.framed.FramedStream r0 = com.squareup.okhttp.internal.framed.FramedStream.this     // Catch:{ all -> 0x0087 }
                int r4 = r0.f309id     // Catch:{ all -> 0x0087 }
