...
final class DistinguishedNameParser {
    ...
    private String quotedAV() {
        ...
        while (true) {
            ...
            if (i2 != this.length) {
                ...
                throw new IllegalStateException("Unexpected end of DN: " + this.f311dn);
            }
        }
    }
    ...
    private int getByte(int position) {
        ...
        if (position + 1 < this.length) {
            ...
            if (b12 >= '0' && b12 <= '9') {
                ...
                throw new IllegalStateException("Malformed DN: " + this.f311dn);
            } else {
                b1 = b12 - '7';
            }
    ...
    public String findMostSpecific(String attributeType) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f311dn.toCharArray();
