...
public class VolleyLog {
    ...
    public static void setTag(String tag) {
        m391d("Changing log tag to %s", tag);
        TAG = tag;
        DEBUG = Log.isLoggable(tag, 2);
    }

    /* renamed from: v */
    public static void m394v(String format, Object... args) {
        if (DEBUG) {
    ...
    /* renamed from: d */
    public static void m391d(String format, Object... args) {
        Log.d(TAG, buildMessage(format, args));
    }

    /* renamed from: e */
    public static void m392e(String format, Object... args) {
        Log.e(TAG, buildMessage(format, args));
    }

    /* renamed from: e */
    public static void m393e(Throwable tr, String format, Object... args) {
    ...
    static class MarkerLog {
        ...
        public synchronized void finish(String header) {
            synchronized (this) {
                ...
                if (duration > 0) {
                    ...
                    VolleyLog.m391d("(%-4d ms) %s", Long.valueOf(duration), header);
                    for (Marker marker : this.mMarkers) {
                        long thisTime = marker.time;
                        VolleyLog.m391d("(+%-4d) [%2d] %s", Long.valueOf(thisTime - prevTime), Long.valueOf(marker.thread), marker.name);
                        prevTime = thisTime;
                    }
                }
            }
        ...
        public void finalize() throws Throwable {
            if (!this.mFinished) {
                ...
                VolleyLog.m392e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
