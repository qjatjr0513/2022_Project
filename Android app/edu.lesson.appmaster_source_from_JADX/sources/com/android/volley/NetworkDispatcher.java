...
public class NetworkDispatcher extends Thread {
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                VolleyLog.m392e("Ignoring spurious interrupt of NetworkDispatcher thread; use quit() to terminate it", new Object[0]);
            }
        }
    }
    ...
    public void processRequest(Request<?> request) {
        ...
        try {
            ...
            VolleyLog.m393e(e, "Unhandled exception %s", e.toString());
