...
public final class WindowInsetsAnimationCompat {
    ...
    private static class Impl21 extends Impl {
        ...
        static void setCallback(View view, Callback callback) {
            Object userListener = view.getTag(C2308R.C2311id.tag_on_apply_window_listener);
            if (callback == null) {
                view.setTag(C2308R.C2311id.tag_window_insets_animation_callback, (Object) null);
            ...
            view.setTag(C2308R.C2311id.tag_window_insets_animation_callback, proxyListener);
            if (userListener == null) {
        ...
        private static class Impl21OnApplyWindowInsetsListener implements View.OnApplyWindowInsetsListener {
            ...
            public WindowInsets onApplyWindowInsets(View v, WindowInsets insets) {
                ...
                C16371 r9 = r0;
                final View view2 = v;
                C16371 r0 = new ValueAnimator.AnimatorUpdateListener() {
        ...
        static WindowInsets forwardToViewIfNeeded(View v, WindowInsets insets) {
            if (v.getTag(C2308R.C2311id.tag_on_apply_window_listener) != null) {
                return insets;
            }
        ...
        static Callback getCallback(View child) {
            Object listener = child.getTag(C2308R.C2311id.tag_window_insets_animation_callback);
