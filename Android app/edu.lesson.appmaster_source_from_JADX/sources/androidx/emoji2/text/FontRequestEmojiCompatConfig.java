...
public class FontRequestEmojiCompatConfig extends EmojiCompat.Config {
    ...
    private static class FontRequestMetadataLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        public void loadInternal() {
            synchronized (this.mLock) {
                if (this.mCallback != null) {
                    ...
                    this.mExecutor.execute(new C1680xc2d47b97(this));
                }
            }
        }
        ...
        private void scheduleRetry(Uri uri, long waitMs) {
            synchronized (this.mLock) {
                ...
                if (this.mObserver == null) {
                    C16791 r2 = new ContentObserver(handler) {
                ...
                if (this.mMainHandlerLoadCallback == null) {
                    this.mMainHandlerLoadCallback = new C1681xc2d47b98(this);
                }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:30:?, code lost:
            androidx.core.p008os.TraceCompat.beginSection(S_TRACE_BUILD_TYPEFACE);
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:35:?, code lost:
            androidx.core.p008os.TraceCompat.endSection();
            r2 = r7.mLock;
         */
        ...
        public void createMetadata() {
            ...
            L_0x0034:
                ...
                androidx.core.p008os.TraceCompat.beginSection(r2)     // Catch:{ all -> 0x0074 }
                ...
                androidx.core.p008os.TraceCompat.endSection()     // Catch:{ all -> 0x0098 }
                java.lang.Object r2 = r7.mLock     // Catch:{ all -> 0x0098 }
                monitor-enter(r2)     // Catch:{ all -> 0x0098 }
