...
public final class MetadataItem extends Table {
    ...
    /* renamed from: id */
    public int mo26349id() {
        int o = __offset(4);
        if (o != 0) {
            return this.f401bb.getInt(this.bb_pos + o);
        }
        return 0;
    }
    ...
    public boolean emojiStyle() {
        int o = __offset(6);
        return (o == 0 || this.f401bb.get(this.bb_pos + o) == 0) ? false : true;
    }

    public short sdkAdded() {
        int o = __offset(8);
        if (o != 0) {
            return this.f401bb.getShort(this.bb_pos + o);
        }
        return 0;
    }
    ...
    public int codepoints(int j) {
        int o = __offset(16);
        if (o != 0) {
            return this.f401bb.getInt(__vector(o) + (j * 4));
        }
        return 0;
    }
    ...
    public IntVector codepointsVector(IntVector obj) {
        int o = __offset(16);
        if (o != 0) {
            return obj.__assign(__vector(o), this.f401bb);
        }
        return null;
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataItem get(MetadataItem obj, int j) {
            return obj.__assign(MetadataItem.__indirect(__element(j), this.f395bb), this.f395bb);
        }
    }
}
