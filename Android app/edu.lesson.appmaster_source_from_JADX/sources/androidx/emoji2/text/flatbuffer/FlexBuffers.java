...
public class FlexBuffers {
    ...
    public static class Reference {
        ...
        public int asInt() {
            int i = this.type;
            if (i == 1) {
                return FlexBuffers.readInt(this.f398bb, this.end, this.parentWidth);
            }
            switch (i) {
                case 0:
                    return 0;
                case 2:
                    return (int) FlexBuffers.readUInt(this.f398bb, this.end, this.parentWidth);
                case 3:
                    return (int) FlexBuffers.readDouble(this.f398bb, this.end, this.parentWidth);
                case 5:
                    return Integer.parseInt(asString());
                case 6:
                    ReadBuf readBuf = this.f398bb;
                    return FlexBuffers.readInt(readBuf, FlexBuffers.indirect(readBuf, this.end, this.parentWidth), this.byteWidth);
                case 7:
                    ReadBuf readBuf2 = this.f398bb;
                    return (int) FlexBuffers.readUInt(readBuf2, FlexBuffers.indirect(readBuf2, this.end, this.parentWidth), this.parentWidth);
                case 8:
                    ReadBuf readBuf3 = this.f398bb;
        ...
        public long asUInt() {
            int i = this.type;
            if (i == 2) {
                return FlexBuffers.readUInt(this.f398bb, this.end, this.parentWidth);
            }
            switch (i) {
                case 0:
                    return 0;
                case 1:
                    return FlexBuffers.readLong(this.f398bb, this.end, this.parentWidth);
                case 3:
                    return (long) FlexBuffers.readDouble(this.f398bb, this.end, this.parentWidth);
                case 5:
                ...
                case 26:
                    return (long) FlexBuffers.readInt(this.f398bb, this.end, this.parentWidth);
                default:
                    return 0;
            }
        }
        ...
        public double asFloat() {
            int i = this.type;
            if (i == 3) {
                return FlexBuffers.readDouble(this.f398bb, this.end, this.parentWidth);
            }
            switch (i) {
                case 0:
                    return 0.0d;
                case 1:
                    return (double) FlexBuffers.readInt(this.f398bb, this.end, this.parentWidth);
                case 2:
                case 26:
                    return (double) FlexBuffers.readUInt(this.f398bb, this.end, this.parentWidth);
                case 5:
        ...
        public String asString() {
            if (isString()) {
                int start = FlexBuffers.indirect(this.f398bb, this.end, this.parentWidth);
                ReadBuf readBuf = this.f398bb;
                int i = this.byteWidth;
                return this.f398bb.getString(start, (int) FlexBuffers.readUInt(readBuf, start - i, i));
            } else if (isKey() == 0) {
                return "";
            } else {
                int start2 = FlexBuffers.indirect(this.f398bb, this.end, this.byteWidth);
                int i2 = start2;
                while (this.f398bb.get(i2) != 0) {
                    i2++;
                }
                return this.f398bb.getString(start2, i2 - start2);
            }
        }
    ...
    private static abstract class Sized extends Object {
        ...
        Sized(ReadBuf buff, int end, int byteWidth) {
            ...
            this.size = FlexBuffers.readInt(this.f397bb, end - byteWidth, byteWidth);
        }
    ...
    public static class Blob extends Sized {
        ...
        public ByteBuffer data() {
            ByteBuffer dup = ByteBuffer.wrap(this.f397bb.data());
        ...
        public byte[] getBytes() {
            ...
            for (int i = 0; i < size; i++) {
                result[i] = this.f397bb.get(this.end + i);
            }
            return result;
        }
        ...
        public byte get(int pos) {
            if (pos >= 0 && pos <= size()) {
                return this.f397bb.get(this.end + pos);
            }
            throw new AssertionError();
        }

        public String toString() {
            return this.f397bb.getString(this.end, size());
        }

        public StringBuilder toString(StringBuilder sb) {
            sb.append('\"');
            sb.append(this.f397bb.getString(this.end, size()));
            return sb.append('\"');
        }
    }
    ...
    public static class Key extends Object {
        ...
        public String toString() {
            int i = this.end;
            while (this.f397bb.get(i) != 0) {
                i++;
            }
            return this.f397bb.getString(this.end, i - this.end);
        }
    ...
    public static class Map extends Vector {
        ...
        public KeyVector keys() {
            ...
            return new KeyVector(new TypedVector(this.f397bb, FlexBuffers.indirect(this.f397bb, keysOffset, this.byteWidth), FlexBuffers.readInt(this.f397bb, this.byteWidth + keysOffset, this.byteWidth), 4));
        }

        public Vector values() {
            return new Vector(this.f397bb, this.end, this.byteWidth);
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int index) {
            ...
            int packedType = Unsigned.byteToUnsignedInt(this.f397bb.get((int) (((long) this.end) + (((long) this.byteWidth) * len) + ((long) index))));
            return new Reference(this.f397bb, this.end + (this.byteWidth * index), this.byteWidth, packedType);
        }
    }
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int pos) {
            ...
            return new Reference(this.f397bb, this.end + (this.byteWidth * pos), this.byteWidth, 1, this.elemType);
        }
    }
    ...
    public static class KeyVector {
        ...
        public Key get(int pos) {
            ...
            return new Key(this.vec.f397bb, FlexBuffers.indirect(this.vec.f397bb, this.vec.end + (this.vec.byteWidth * pos), this.vec.byteWidth), 1);
        }
