...
public class Motion implements TypedValues {
    ...
    public MotionKeyPosition getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        start.left = this.mStartMotionPath.f335x;
        start.top = this.mStartMotionPath.f336y;
        ...
        end.left = this.mEndMotionPath.f335x;
        end.top = this.mEndMotionPath.f336y;
    ...
    public float getKeyFrameParameter(int type, float x, float y) {
        float dx = this.mEndMotionPath.f335x - this.mStartMotionPath.f335x;
        float dy = this.mEndMotionPath.f336y - this.mStartMotionPath.f336y;
        float startCenterX = this.mStartMotionPath.f335x + (this.mStartMotionPath.width / 2.0f);
        float startCenterY = this.mStartMotionPath.f336y + (this.mStartMotionPath.height / 2.0f);
            ...
            case -1:
                ...
                return new DifferentialInterpolator() {
                    ...
                    public float getVelocity() {
                        return (float) easing.getDiff((double) this.f332mX);
                    }
                };
            default:
                return null;
    ...
    public boolean interpolate(MotionWidget child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float float_l = this.mStartMotionPath.f335x + ((this.mEndMotionPath.f335x - this.mStartMotionPath.f335x) * position);
            float float_t = this.mStartMotionPath.f336y + ((this.mEndMotionPath.f336y - this.mStartMotionPath.f336y) * position);
    ...
    public void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float dleft = this.mEndMotionPath.f335x - this.mStartMotionPath.f335x;
        float dTop = this.mEndMotionPath.f336y - this.mStartMotionPath.f336y;
