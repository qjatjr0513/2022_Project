...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SearchView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mIconifiedByDefaultId = propertyMapper.mapBoolean("iconifiedByDefault", C2281R.attr.iconifiedByDefault);
            this.mQueryHintId = propertyMapper.mapObject("queryHint", C2281R.attr.queryHint);
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C2281R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        C14915 r8 = new View.OnClickListener() {
        ...
        C14937 r9 = new TextView.OnEditorActionListener() {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C2281R.styleable.SearchView, defStyleAttr, 0);
        TintTypedArray a2 = a;
        ViewCompat.saveAttributeDataForStyleable(this, context, C2281R.styleable.SearchView, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        LayoutInflater inflater = LayoutInflater.from(context);
        int layoutResId = a2.getResourceId(C2281R.styleable.SearchView_layout, C2281R.layout.abc_search_view);
        inflater.inflate(layoutResId, this, true);
        SearchAutoComplete searchAutoComplete = (SearchAutoComplete) findViewById(C2281R.C2284id.search_src_text);
        this.mSearchSrcTextView = searchAutoComplete;
        searchAutoComplete.setSearchView(this);
        this.mSearchEditFrame = findViewById(C2281R.C2284id.search_edit_frame);
        View findViewById = findViewById(C2281R.C2284id.search_plate);
        this.mSearchPlate = findViewById;
        View findViewById2 = findViewById(C2281R.C2284id.submit_area);
        this.mSubmitArea = findViewById2;
        ImageView imageView = (ImageView) findViewById(C2281R.C2284id.search_button);
        this.mSearchButton = imageView;
        ImageView imageView2 = (ImageView) findViewById(C2281R.C2284id.search_go_btn);
        this.mGoButton = imageView2;
        LayoutInflater layoutInflater = inflater;
        ImageView imageView3 = (ImageView) findViewById(C2281R.C2284id.search_close_btn);
        this.mCloseButton = imageView3;
        int i = layoutResId;
        ImageView imageView4 = (ImageView) findViewById(C2281R.C2284id.search_voice_btn);
        this.mVoiceButton = imageView4;
        ImageView imageView5 = (ImageView) findViewById(C2281R.C2284id.search_mag_icon);
        this.mCollapsedIcon = imageView5;
        ViewCompat.setBackground(findViewById, a2.getDrawable(C2281R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(findViewById2, a2.getDrawable(C2281R.styleable.SearchView_submitBackground));
        imageView.setImageDrawable(a2.getDrawable(C2281R.styleable.SearchView_searchIcon));
        imageView2.setImageDrawable(a2.getDrawable(C2281R.styleable.SearchView_goIcon));
        imageView3.setImageDrawable(a2.getDrawable(C2281R.styleable.SearchView_closeIcon));
        imageView4.setImageDrawable(a2.getDrawable(C2281R.styleable.SearchView_voiceIcon));
        imageView5.setImageDrawable(a2.getDrawable(C2281R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a2.getDrawable(C2281R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(imageView, getResources().getString(C2281R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a2.getResourceId(C2281R.styleable.SearchView_suggestionRowLayout, C2281R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a2.getResourceId(C2281R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(a2.getBoolean(C2281R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a2.getDimensionPixelSize(C2281R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a2.getText(C2281R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a2.getText(C2281R.styleable.SearchView_queryHint);
        int imeOptions = a2.getInt(C2281R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a2.getInt(C2281R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a2.getBoolean(C2281R.styleable.SearchView_android_focusable, true));
        a2.recycle();
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C2281R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C2281R.dimen.abc_search_view_preferred_height);
    }
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                iconOffset = res.getDimensionPixelSize(C2281R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C2281R.dimen.abc_dropdownitem_text_padding_left);
            } else {
                iconOffset = 0;
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C2281R.attr.autoCompleteTextViewStyle);
        }
