...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C2281R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C2281R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C2281R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C2281R.styleable.ActionBar_height, -1);
        boolean z = true;
        if (getId() == C2281R.C2284id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C2281R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        if (this.mIsSplit) {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C2281R.C2284id.action_bar);
        this.mContextView = findViewById(C2281R.C2284id.action_context_bar);
    }
