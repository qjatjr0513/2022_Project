...
public class AppCompatRadioButton extends RadioButton implements TintableCompoundButton, TintableBackgroundView, EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatRadioButton> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mButtonTintId = propertyMapper.mapObject("buttonTint", C2281R.attr.buttonTint);
            this.mButtonTintModeId = propertyMapper.mapObject("buttonTintMode", C2281R.attr.buttonTintMode);
    ...
    public AppCompatRadioButton(Context context, AttributeSet attrs) {
        this(context, attrs, C2281R.attr.radioButtonStyle);
    }
