...
public class AppCompatCheckedTextView extends CheckedTextView implements TintableCheckedTextView, TintableBackgroundView, EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatCheckedTextView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mCheckMarkTintId = propertyMapper.mapObject("checkMarkTint", C2281R.attr.checkMarkTint);
            this.mCheckMarkTintModeId = propertyMapper.mapObject("checkMarkTintMode", C2281R.attr.checkMarkTintMode);
    ...
    public AppCompatCheckedTextView(Context context, AttributeSet attrs) {
        this(context, attrs, C2281R.attr.checkedTextViewStyle);
    }
