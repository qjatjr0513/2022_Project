    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C2281R.C2284id.topPanel) {
                    topPanel = child;
                } else if (id == C2281R.C2284id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C2281R.C2284id.contentPanel && id != C2281R.C2284id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
