...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(C2281R.attr.actionBarPopupTheme, tv, true) || tv.resourceId == 0) {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes((AttributeSet) null, C2281R.styleable.ActionBar, C2281R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C2281R.styleable.ActionBar_height, 0));
        a.recycle();
