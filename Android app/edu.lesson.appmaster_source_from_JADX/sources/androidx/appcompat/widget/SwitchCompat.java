...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SwitchCompat> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mShowTextId = propertyMapper.mapBoolean("showText", C2281R.attr.showText);
            this.mSplitTrackId = propertyMapper.mapBoolean("splitTrack", C2281R.attr.splitTrack);
            this.mSwitchMinWidthId = propertyMapper.mapInt("switchMinWidth", C2281R.attr.switchMinWidth);
            this.mSwitchPaddingId = propertyMapper.mapInt("switchPadding", C2281R.attr.switchPadding);
            this.mThumbTextPaddingId = propertyMapper.mapInt("thumbTextPadding", C2281R.attr.thumbTextPadding);
            this.mThumbTintId = propertyMapper.mapObject("thumbTint", C2281R.attr.thumbTint);
            this.mThumbTintModeId = propertyMapper.mapObject("thumbTintMode", C2281R.attr.thumbTintMode);
            this.mTrackId = propertyMapper.mapObject("track", C2281R.attr.track);
            this.mTrackTintId = propertyMapper.mapObject("trackTint", C2281R.attr.trackTint);
            this.mTrackTintModeId = propertyMapper.mapObject("trackTintMode", C2281R.attr.trackTintMode);
    ...
    public SwitchCompat(Context context, AttributeSet attrs) {
        this(context, attrs, C2281R.attr.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C2281R.styleable.SwitchCompat, defStyleAttr, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C2281R.styleable.SwitchCompat, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        Drawable drawable = a.getDrawable(C2281R.styleable.SwitchCompat_android_thumb);
        this.mThumbDrawable = drawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        Drawable drawable2 = a.getDrawable(C2281R.styleable.SwitchCompat_track);
        this.mTrackDrawable = drawable2;
        if (drawable2 != null) {
            drawable2.setCallback(this);
        }
        setTextOnInternal(a.getText(C2281R.styleable.SwitchCompat_android_textOn));
        setTextOffInternal(a.getText(C2281R.styleable.SwitchCompat_android_textOff));
        this.mShowText = a.getBoolean(C2281R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = a.getDimensionPixelSize(C2281R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = a.getDimensionPixelSize(C2281R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = a.getDimensionPixelSize(C2281R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = a.getBoolean(C2281R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList thumbTintList = a.getColorStateList(C2281R.styleable.SwitchCompat_thumbTint);
        if (thumbTintList != null) {
            this.mThumbTintList = thumbTintList;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode thumbTintMode = DrawableUtils.parseTintMode(a.getInt(C2281R.styleable.SwitchCompat_thumbTintMode, -1), (PorterDuff.Mode) null);
        ...
        ColorStateList trackTintList = a.getColorStateList(C2281R.styleable.SwitchCompat_trackTint);
        if (trackTintList != null) {
            this.mTrackTintList = trackTintList;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode trackTintMode = DrawableUtils.parseTintMode(a.getInt(C2281R.styleable.SwitchCompat_trackTintMode, -1), (PorterDuff.Mode) null);
        ...
        int appearance = a.getResourceId(C2281R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (appearance != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        TintTypedArray appearance = TintTypedArray.obtainStyledAttributes(context, resid, C2281R.styleable.TextAppearance);
        ColorStateList colors = appearance.getColorStateList(C2281R.styleable.TextAppearance_android_textColor);
        if (colors != null) {
            this.mTextColors = colors;
        } else {
            this.mTextColors = getTextColors();
        }
        int ts = appearance.getDimensionPixelSize(C2281R.styleable.TextAppearance_android_textSize, 0);
        if (!(ts == 0 || ((float) ts) == this.mTextPaint.getTextSize())) {
            this.mTextPaint.setTextSize((float) ts);
            requestLayout();
        }
        setSwitchTypefaceByIndex(appearance.getInt(C2281R.styleable.TextAppearance_android_typeface, -1), appearance.getInt(C2281R.styleable.TextAppearance_android_textStyle, -1));
        if (appearance.getBoolean(C2281R.styleable.TextAppearance_textAllCaps, false)) {
    ...
    private void setOnStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (charSequence == null) {
                charSequence = getResources().getString(C2281R.string.abc_capital_on);
            }
    ...
    private void setOffStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (charSequence == null) {
                charSequence = getResources().getString(C2281R.string.abc_capital_off);
            }
            ViewCompat.setStateDescription(this, charSequence);
        }
    }
