...
class AppCompatCheckedTextViewHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        int resourceId;
        int resourceId2;
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attrs, C2281R.styleable.CheckedTextView, defStyleAttr, 0);
        CheckedTextView checkedTextView = this.mView;
        ViewCompat.saveAttributeDataForStyleable(checkedTextView, checkedTextView.getContext(), C2281R.styleable.CheckedTextView, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        boolean checkMarkDrawableLoaded = false;
        try {
            if (a.hasValue(C2281R.styleable.CheckedTextView_checkMarkCompat) && (resourceId2 = a.getResourceId(C2281R.styleable.CheckedTextView_checkMarkCompat, 0)) != 0) {
                try {
            ...
            if (!checkMarkDrawableLoaded) {
                if (a.hasValue(C2281R.styleable.CheckedTextView_android_checkMark) && (resourceId = a.getResourceId(C2281R.styleable.CheckedTextView_android_checkMark, 0)) != 0) {
            ...
            if (a.hasValue(C2281R.styleable.CheckedTextView_checkMarkTint)) {
                CheckedTextViewCompat.setCheckMarkTintList(this.mView, a.getColorStateList(C2281R.styleable.CheckedTextView_checkMarkTint));
            }
            if (a.hasValue(C2281R.styleable.CheckedTextView_checkMarkTintMode)) {
                CheckedTextViewCompat.setCheckMarkTintMode(this.mView, DrawableUtils.parseTintMode(a.getInt(C2281R.styleable.CheckedTextView_checkMarkTintMode, -1), (PorterDuff.Mode) null));
            }
        } finally {
            a.recycle();
        }
