...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs) {
        this(context, attrs, C2281R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C2281R.styleable.ActionMode, defStyle, 0);
        ViewCompat.setBackground(this, a.getDrawable(C2281R.styleable.ActionMode_background));
        this.mTitleStyleRes = a.getResourceId(C2281R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = a.getResourceId(C2281R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = a.getLayoutDimension(C2281R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = a.getResourceId(C2281R.styleable.ActionMode_closeItemLayout, C2281R.layout.abc_action_mode_close_item_material);
        a.recycle();
    }
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C2281R.layout.abc_action_bar_title_item, this);
            LinearLayout linearLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleLayout = linearLayout;
            this.mTitleView = (TextView) linearLayout.findViewById(C2281R.C2284id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C2281R.C2284id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        View findViewById = this.mClose.findViewById(C2281R.C2284id.action_mode_close_button);
