...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta = context.obtainStyledAttributes(attrs, C2281R.styleable.ButtonBarLayout);
        ViewCompat.saveAttributeDataForStyleable(this, context, C2281R.styleable.ButtonBarLayout, attrs, ta, 0, 0);
        this.mAllowStacking = ta.getBoolean(C2281R.styleable.ButtonBarLayout_allowStacking, true);
        ta.recycle();
        if (getOrientation() == 1) {
    ...
    private void setStacked(boolean stacked) {
        ...
        if (!stacked || this.mAllowStacking) {
            ...
            View spacer = findViewById(C2281R.C2284id.spacer);
            if (spacer != null) {
