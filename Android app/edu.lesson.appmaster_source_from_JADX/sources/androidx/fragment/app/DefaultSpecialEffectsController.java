...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    public void executeOperations(List<SpecialEffectsController.Operation> operations, boolean isPop) {
        ...
        for (SpecialEffectsController.Operation operation : operations) {
            ...
            switch (C168610.f402xe493b431[operation.getFinalState().ordinal()]) {
                case 1:
                case 2:
                case 3:
    ...
    static /* synthetic */ class C168610 {
        ...
        static {
            ...
            try {
                f402xe493b431[SpecialEffectsController.Operation.State.INVISIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f402xe493b431[SpecialEffectsController.Operation.State.REMOVED.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f402xe493b431[SpecialEffectsController.Operation.State.VISIBLE.ordinal()] = 4;
                ...
                if (anim == null) {
                    ...
                    if (animator == null) {
                        ...
                        if (Boolean.TRUE.equals(startedTransitions.get(operation))) {
                            ...
                            C16872 r0 = new AnimatorListenerAdapter() {
