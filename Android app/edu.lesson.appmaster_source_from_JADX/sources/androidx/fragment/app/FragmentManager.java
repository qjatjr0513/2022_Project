...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    static Fragment getViewFragment(View view) {
        Object tag = view.getTag(C2329R.C2332id.fragment_container_view_tag);
    ...
    private void executeOpsTogether(java.util.ArrayList<androidx.fragment.app.BackStackRecord> r20, java.util.ArrayList<java.lang.Boolean> r21, int r22, int r23) {
        ...
        L_0x0083:
            ...
            androidx.fragment.app.FragmentTransaction$Op r10 = (androidx.fragment.app.FragmentTransaction.C1736Op) r10
        ...
        L_0x00e2:
            ...
            androidx.fragment.app.FragmentTransaction$Op r11 = (androidx.fragment.app.FragmentTransaction.C1736Op) r11
    ...
    private Set<SpecialEffectsController> collectChangedControllers(ArrayList<BackStackRecord> records, int startIndex, int endIndex) {
        ...
        for (int index = startIndex; index < endIndex; index++) {
            ...
            while (it.hasNext()) {
                Fragment fragment = ((FragmentTransaction.C1736Op) it.next()).mFragment;
    ...
    private void setVisibleRemovingFragment(Fragment f) {
        ...
        if (container != null && f.getEnterAnim() + f.getExitAnim() + f.getPopEnterAnim() + f.getPopExitAnim() > 0) {
            if (container.getTag(C2329R.C2332id.visible_removing_fragment_view_tag) == null) {
                container.setTag(C2329R.C2332id.visible_removing_fragment_view_tag, f);
            }
            ((Fragment) container.getTag(C2329R.C2332id.visible_removing_fragment_view_tag)).setPopDirection(f.getPopDirection());
        }
    }
