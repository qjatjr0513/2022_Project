...
import androidx.recyclerview.C2366R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, C2366R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context2.obtainStyledAttributes(attributeSet, C2366R.styleable.RecyclerView, i, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C2366R.styleable.RecyclerView, attrs, a, defStyleAttr, 0);
        }
        String layoutManagerName = a.getString(C2366R.styleable.RecyclerView_layoutManager);
        int descendantFocusability = a.getInt(C2366R.styleable.RecyclerView_android_descendantFocusability, -1);
        if (descendantFocusability == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = a.getBoolean(C2366R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z = a.getBoolean(C2366R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z;
        if (z) {
            initFastScroller((StateListDrawable) a.getDrawable(C2366R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a.getDrawable(C2366R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a.getDrawable(C2366R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a.getDrawable(C2366R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        a.recycle();
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            C18491 r0 = new ViewBoundsCheck.Callback() {
            ...
            C18502 r1 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int index) {
                    return LayoutManager.this.getChildAt(index);
                }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C2366R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C2366R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C2366R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C2366R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C2366R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C2366R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C2366R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C2366R.dimen.fastscroll_margin));
    }
