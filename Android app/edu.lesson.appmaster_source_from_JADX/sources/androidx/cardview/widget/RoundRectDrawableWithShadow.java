...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius, float shadowSize, float maxShadowSize) {
        this.mShadowStartColor = resources.getColor(C2297R.C2298color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C2297R.C2298color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C2297R.dimen.cardview_compat_inset_shadow);
